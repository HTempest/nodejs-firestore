...
describe('instantiation', () => {
    ...
    it('validates project ID is string', () => {
        chai_1.expect(() => {
            const settings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), { projectId: 1337 });
    ...
    it('validates ssl is a boolean', () => {
        ...
        for (const value of invalidValues) {
            chai_1.expect(() => {
                const settings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), { ssl: value });
                new Firestore.Firestore(settings);
    ...
    it('validates maxIdleChannels', () => {
        ...
        for (const value of invalidValues) {
            chai_1.expect(() => {
                const settings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), { maxIdleChannels: value });
                new Firestore.Firestore(settings);
            }).to.throw();
        }
...
describe('getAll() method', () => {
    ...
    function resultEquals(result, ...docs) {
        chai_1.expect(result.length).to.equal(arguments.length - 1);
